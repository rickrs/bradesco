    ...
    <header class="first">
      <div class="container">
        ...
        <div class="video" style="max-width: 820px; width: 100%; margin: 30px auto;display:none;">
          <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://www.youtube.com/embed/U8ZgzBdA564' frameborder='0' allowfullscreen></iframe></div>
        </div>
        <div class="btns">
